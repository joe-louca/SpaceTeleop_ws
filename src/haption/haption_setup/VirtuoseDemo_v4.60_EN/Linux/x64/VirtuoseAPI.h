...
#define DEBUG_LOOP	0x0002
  ...
  inline int virtGetAnalogicInputs (VirtContext VC, float* inputs) { return virtCallDLL(ANA_INPUTS,VC, inputs); } 
  ...
  inline int virtGetTorInputs(VirtContext VC, unsigned int *tor_in) { return virtCallDLL(TOR_INPUTS, VC, tor_in); } 
  ...
  inline int virtSetPwmOutput(VirtContext VC, float *pwm) { return virtCallDLL(SETPWM,VC,pwm); }
  ...
  inline int virtGetNbAxes(VirtContext VC, int* nbAxes) { return virtCallDLL(GETNBAXES,VC,nbAxes); }
  inline int virtSetFingerTipSpeed(VirtContext VC, float *speed) { return virtCallDLL(FINGERTIPSPEED,VC,speed); } 
